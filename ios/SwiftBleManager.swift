        ...
        if #available(iOS 18.0, *) {
            ...
            session.activate(on: DispatchQueue.main) { [weak self] event in
                ...
                switch event.eventType {
                        case .pickerDidPresent:   eventName = "pickerDidPresent"
                        case .pickerDidDismiss:   eventName = "pickerDidDismiss"
                        case .pickerSetupBridging:eventName = "pickerSetupBridging"
                        case .pickerSetupPairing: eventName = "pickerSetupPairing"
                        case .pickerSetupFailed:  eventName = "pickerSetupFailed"
                        case .pickerSetupRename:  eventName = "pickerSetupRename"
                        case .migrationComplete:  eventName = "migrationComplete"
                        case .unknown:            eventName = "unknown"
                ...
                self.bleManager?.emit(onAccessorySessionUpdateState: ["state": eventName, "accessories": toArray(map)])
            }
