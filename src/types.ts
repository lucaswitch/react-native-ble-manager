...
export enum IOSAccessoryKitSessionState {
  ...
  AccessoryDiscovered = "accessoryDiscovered",
  PickerDidPresent = "pickerDidPresent",
  PickerDidDismiss = "pickerDidDismiss",
  PickerSetupBridging = "pickerSetupBridging",
  PickerSetupPairing = "pickerSetupPairing",
  PickerSetupFailed = "pickerSetupFailed",
  PickerSetupRename = "pickerSetupRename",
